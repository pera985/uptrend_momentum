...
MAX_STOCKS_TO_SCAN = 100   # Default max stocks for strategies 1,3-8 (None = scan all)
                          # Strategy 2 always scans all stocks
MAX_STOCKS_STRATEGY_9 = 100  # Max stocks to scan for Strategy 9 (None = scan all)
